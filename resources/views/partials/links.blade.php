<link rel='stylesheet' id='contact-form-7-css'
      href='{{asset('css/stile1.css')}}'
      type='text/css' media='all'/>
<link rel='stylesheet' id='rs-plugin-settings-css'
      href='{{asset('css/stile2.css')}}'
      type='text/css' media='all'/>
...
<link rel='stylesheet' id='anwalt_mikado_modules-css'
      href='{{asset('css/stile3.css')}}'
      type='text/css' media='all'/>
<link rel='stylesheet' id='mkdf_font_awesome-css'
      href='{{asset('css/stile4.css')}}'
      type='text/css' media='all'/>
...
<style type="text/css" data-type="vc_shortcodes-custom-css">.vc_custom_1520428609185 {
    ...
    .card__picture {
        ...
        height: 15rem;
        /*se non diamo una altezza mi copre solo una riga*/
        background-blend-mode: screen;
        /*per rendere il colore linear-gradient un po' trasparente e far vedere l'immagine di sfondo*/
    ...
    .card__heading-span--4 {
        background-image: linear-gradient(to right bottom, rgba(220, 224, 11, 0.85), rgba(170, 173, 1, 0.85)); }
    .card__details {
        padding: 3rem; }
    .card__details ul {
        list-style: none;
    ...
    @font-face {
        ...
        src: url({{asset('font/Microsoft-Yi-Baiti.eot')}});
        src: url({{asset('font/Microsoft-Yi-Baiti.eot?#iefix')}}) format('embedded-opentype'),
        url({{asset('font/Microsoft-Yi-Baiti.woff')}}) format('woff'),
        url({{asset('font/Microsoft-Yi-Baiti.ttf')}}) format('truetype');
        font-style: normal;
    }
